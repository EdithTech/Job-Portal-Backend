package com.edithtech.jobportal.exception;

import com.edithtech.jobportal.dto.ErrorResponseDto;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, String>> handleFieldException(MethodArgumentNotValidException exception){
        System.out.println("Validation: " + exception.getMessage());
...
//    public ResponseEntity<Map<String, String>> handleParamException(HandlerMethodValidationException exception){
//        Map<String, String> errors = new HashMap<>();
...
//    }
    ...
    public ResponseEntity<ErrorResponseDto> handleNullException(Exception exception, WebRequest webRequest){
        ErrorResponseDto errorResponseDto = new ErrorResponseDto(webRequest.getDescription(false),
                HttpStatus.INTERNAL_SERVER_ERROR, "Null Exception: "+exception.getMessage(), LocalDateTime.now());
        return new ResponseEntity<>(errorResponseDto, HttpStatus.INTERNAL_SERVER_ERROR);
    }
}
